...
routes.post('/favorite', postFavoriteList) // Añadir a la watchlist
routes.get('/favorite/:userId', getFavoriteList) // Obtener la watchlist de un usuario
routes.delete('/favorite', deleteFavoriteList) // Eliminar de la watchlist
